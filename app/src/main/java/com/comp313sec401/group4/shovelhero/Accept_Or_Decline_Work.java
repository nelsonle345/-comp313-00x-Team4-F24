...
public class Accept_Or_Decline_Work extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acceptButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Accept_Or_Decline_Work.this, "Work Order Accepted", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        declineButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Accept_Or_Decline_Work.this, "Work Order Declined", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
